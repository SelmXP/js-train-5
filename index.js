...
function multiplyByIndex(arr) {
  ...
  for (const index in arr) {
    arr_result = [...arr_result, arr[index] * index];
  }
  return arr_result;
}
...
function replaceNumbers(arr) {
  ...
  for (const item of arr) {
    if (item > 10) {
      arr_result = [...arr_result, "Greater than 10"];
    }
    if (item <= 10) {
      arr_result = [...arr_result, "Less than or equal to 10"];
    }
  }
  return arr_result;
}
